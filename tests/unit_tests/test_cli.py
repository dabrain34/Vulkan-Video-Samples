...
class TestDenyListOptions:
    """Tests for deny list CLI options"""

    def test_ignore_deny_list_option_accepted(self):
        """Test that --ignore-deny-list is a valid option"""
        result = subprocess.run(
            [sys.executable, str(TESTS_DIR / "video_test_framework_codec.py"),
             "--help"],
            capture_output=True,
        ...
        assert "--ignore-deny-list" in result.stdout

    def test_only_denied_option_accepted(self):
        """Test that --only-denied is a valid option"""
        result = subprocess.run(
            [sys.executable, str(TESTS_DIR / "video_test_framework_codec.py"),
             "--help"],
            capture_output=True,
        ...
        assert "--only-denied" in result.stdout

    def test_deny_list_option_accepted(self):
        """Test that --deny-list is a valid option"""
        result = subprocess.run(
            [sys.executable, str(TESTS_DIR / "video_test_framework_codec.py"),
             "--help"],
            capture_output=True,
...
class TestDecodeFrameworkCLI:
    ...
    def test_decode_deny_list_options(self):
        """Test deny list options in decode framework"""
        result = subprocess.run(
            [sys.executable, str(TESTS_DIR / "video_test_framework_decode.py"),
             "--help"],
            capture_output=True,
...
class TestEncodeFrameworkCLI:
    ...
    def test_encode_deny_list_options(self):
        """Test deny list options in encode framework"""
        result = subprocess.run(
            [sys.executable, str(TESTS_DIR / "video_test_framework_encode.py"),
             "--help"],
            capture_output=True,
