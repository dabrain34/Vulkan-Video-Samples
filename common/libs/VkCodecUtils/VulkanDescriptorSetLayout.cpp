...
VkResult VulkanDescriptorSetLayout::CreateDescriptorSet(const VulkanDeviceContext* vkDevCtx,
                                                        ...
                                                        bool autoSelectdescriptorSetLayoutCreateFlags)
{
    ...
    result = m_vkDevCtx->CreatePipelineLayout(*m_vkDevCtx, &pipelineLayoutCreateInfo, nullptr, &m_pipelineLayout);
    if (result != VK_SUCCESS) {
        return result;
    }
