...
VkDeviceSize VkBufferResource::Clone(VkDeviceSize newSize, VkDeviceSize copySize, VkDeviceSize copyOffset,
                                     VkSharedBaseObj<VkBufferResource>& vulkanBitstreamBuffer)
{
    VkSharedBaseObj<VkBufferResource> vkBitstreamBuffer(new VkBufferResource(m_vkDevCtx,
                                                                             m_usage,
...
VkResult VkBufferResource::CreateBuffer(const VulkanDeviceContext* vkDevCtx,
