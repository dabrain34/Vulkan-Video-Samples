...
const FlagName kVideoCapNames[] = {
    { VK_VIDEO_CAPABILITY_PROTECTED_CONTENT_BIT_KHR, "PROTECTED_CONTENT" },
    { VK_VIDEO_CAPABILITY_SEPARATE_REFERENCE_IMAGES_BIT_KHR, "SEPARATE_REFERENCE_IMAGES" },
};

const FlagName kDecodeCapNames[] = {
    { VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_COINCIDE_BIT_KHR, "DPB_AND_OUTPUT_COINCIDE" },
    { VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_DISTINCT_BIT_KHR, "DPB_AND_OUTPUT_DISTINCT" },
};

const FlagName kEncodeH264CapNames[] = {
    { VK_VIDEO_ENCODE_H264_CAPABILITY_HRD_COMPLIANCE_BIT_KHR, "HRD_COMPLIANCE" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR, "PREDICTION_WEIGHT_TABLE_GENERATED" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_ROW_UNALIGNED_SLICE_BIT_KHR, "ROW_UNALIGNED_SLICE" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_DIFFERENT_SLICE_TYPE_BIT_KHR, "DIFFERENT_SLICE_TYPE" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR, "B_FRAME_IN_L0_LIST" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR, "B_FRAME_IN_L1_LIST" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR, "PER_PICTURE_TYPE_MIN_MAX_QP" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_PER_SLICE_CONSTANT_QP_BIT_KHR, "PER_SLICE_CONSTANT_QP" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_GENERATE_PREFIX_NALU_BIT_KHR, "GENERATE_PREFIX_NALU" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_MB_QP_DIFF_WRAPAROUND_BIT_KHR, "MB_QP_DIFF_WRAPAROUND" },
    { VK_VIDEO_ENCODE_H264_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR, "B_PICTURE_INTRA_REFRESH" },
};

const FlagName kEncodeH265CapNames[] = {
    { VK_VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_KHR, "HRD_COMPLIANCE" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR, "PREDICTION_WEIGHT_TABLE_GENERATED" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_KHR, "ROW_UNALIGNED_SLICE_SEGMENT" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_SEGMENT_TYPE_BIT_KHR, "DIFFERENT_SLICE_SEGMENT_TYPE" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR, "B_FRAME_IN_L0_LIST" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR, "B_FRAME_IN_L1_LIST" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR, "PER_PICTURE_TYPE_MIN_MAX_QP" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_PER_SLICE_SEGMENT_CONSTANT_QP_BIT_KHR, "PER_SLICE_SEGMENT_CONSTANT_QP" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILES_PER_SLICE_SEGMENT_BIT_KHR, "MULTIPLE_TILES_PER_SLICE_SEGMENT" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_SEGMENTS_PER_TILE_BIT_KHR, "MULTIPLE_SLICE_SEGMENTS_PER_TILE" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_CU_QP_DIFF_WRAPAROUND_BIT_KHR, "CU_QP_DIFF_WRAPAROUND" },
    { VK_VIDEO_ENCODE_H265_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR, "B_PICTURE_INTRA_REFRESH" },
};

const FlagName kEncodeAV1CapNames[] = {
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_KHR, "PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX" },
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER_BIT_KHR, "GENERATE_OBU_EXTENSION_HEADER" },
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY_BIT_KHR, "PRIMARY_REFERENCE_CDF_ONLY" },
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR, "FRAME_SIZE_OVERRIDE" },
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR, "MOTION_VECTOR_SCALING" },
    { VK_VIDEO_ENCODE_AV1_CAPABILITY_COMPOUND_PREDICTION_INTRA_REFRESH_BIT_KHR, "COMPOUND_PREDICTION_INTRA_REFRESH" },
};

const FlagName kEncodeH264StdNames[] = {
    { VK_VIDEO_ENCODE_H264_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR, "SEPARATE_COLOR_PLANE_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_QPPRIME_Y_ZERO_TRANSFORM_BYPASS_FLAG_SET_BIT_KHR, "QPPRIME_Y_ZERO_TRANSFORM_BYPASS_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_SCALING_MATRIX_PRESENT_FLAG_SET_BIT_KHR, "SCALING_MATRIX_PRESENT_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_CHROMA_QP_INDEX_OFFSET_BIT_KHR, "CHROMA_QP_INDEX_OFFSET" },
    { VK_VIDEO_ENCODE_H264_STD_SECOND_CHROMA_QP_INDEX_OFFSET_BIT_KHR, "SECOND_CHROMA_QP_INDEX_OFFSET" },
    { VK_VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR, "PIC_INIT_QP_MINUS26" },
    { VK_VIDEO_ENCODE_H264_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR, "WEIGHTED_PRED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_EXPLICIT_BIT_KHR, "WEIGHTED_BIPRED_IDC_EXPLICIT" },
    { VK_VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_IMPLICIT_BIT_KHR, "WEIGHTED_BIPRED_IDC_IMPLICIT" },
    { VK_VIDEO_ENCODE_H264_STD_TRANSFORM_8X8_MODE_FLAG_SET_BIT_KHR, "TRANSFORM_8X8_MODE_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_DIRECT_SPATIAL_MV_PRED_FLAG_UNSET_BIT_KHR, "DIRECT_SPATIAL_MV_PRED_FLAG_UNSET" },
    { VK_VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR, "ENTROPY_CODING_MODE_FLAG_UNSET" },
    { VK_VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR, "ENTROPY_CODING_MODE_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_DIRECT_8X8_INFERENCE_FLAG_UNSET_BIT_KHR, "DIRECT_8X8_INFERENCE_FLAG_UNSET" },
    { VK_VIDEO_ENCODE_H264_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR, "CONSTRAINED_INTRA_PRED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_DISABLED_BIT_KHR, "DEBLOCKING_FILTER_DISABLED" },
    { VK_VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_ENABLED_BIT_KHR, "DEBLOCKING_FILTER_ENABLED" },
    { VK_VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_PARTIAL_BIT_KHR, "DEBLOCKING_FILTER_PARTIAL" },
...
const FlagName kEncodeH265StdNames[] = {
    { VK_VIDEO_ENCODE_H265_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR, "SEPARATE_COLOR_PLANE_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET_BIT_KHR, "SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_SCALING_LIST_DATA_PRESENT_FLAG_SET_BIT_KHR, "SCALING_LIST_DATA_PRESENT_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_PCM_ENABLED_FLAG_SET_BIT_KHR, "PCM_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_SPS_TEMPORAL_MVP_ENABLED_FLAG_SET_BIT_KHR, "SPS_TEMPORAL_MVP_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_INIT_QP_MINUS26_BIT_KHR, "INIT_QP_MINUS26" },
    { VK_VIDEO_ENCODE_H265_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR, "WEIGHTED_PRED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_WEIGHTED_BIPRED_FLAG_SET_BIT_KHR, "WEIGHTED_BIPRED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_KHR, "LOG2_PARALLEL_MERGE_LEVEL_MINUS2" },
    { VK_VIDEO_ENCODE_H265_STD_SIGN_DATA_HIDING_ENABLED_FLAG_SET_BIT_KHR, "SIGN_DATA_HIDING_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_KHR, "TRANSFORM_SKIP_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_KHR, "TRANSFORM_SKIP_ENABLED_FLAG_UNSET" },
    { VK_VIDEO_ENCODE_H265_STD_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET_BIT_KHR, "PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_TRANSQUANT_BYPASS_ENABLED_FLAG_SET_BIT_KHR, "TRANSQUANT_BYPASS_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR, "CONSTRAINED_INTRA_PRED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_ENTROPY_CODING_SYNC_ENABLED_FLAG_SET_BIT_KHR, "ENTROPY_CODING_SYNC_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_DEBLOCKING_FILTER_OVERRIDE_ENABLED_FLAG_SET_BIT_KHR, "DEBLOCKING_FILTER_OVERRIDE_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENTS_ENABLED_FLAG_SET_BIT_KHR, "DEPENDENT_SLICE_SEGMENTS_ENABLED_FLAG_SET" },
    { VK_VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENT_FLAG_SET_BIT_KHR, "DEPENDENT_SLICE_SEGMENT_FLAG_SET" },
...
const FlagName kEncodeAV1StdNames[] = {
    { VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET_BIT_KHR, "UNIFORM_TILE_SPACING_FLAG_SET" },
    { VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET_BIT_KHR, "SKIP_MODE_PRESENT_UNSET" },
    { VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME_BIT_KHR, "PRIMARY_REF_FRAME" },
    { VK_VIDEO_ENCODE_AV1_STD_DELTA_Q_BIT_KHR, "DELTA_Q" },
};
...
{
    EMIT_FLAGS("flags", caps.flags, kVideoCapNames);
...
void dumpDecodeCaps(const VulkanDeviceContext* vkDevCtx, VkVideoCodecOperationFlagBitsKHR codec)
{
    ...
    for (const SupportedProfile& sp : profiles) {
        ...
        EMIT_FLAGS("flags", decodeCaps.flags, kDecodeCapNames);
...
{
    EMIT_FLAGS("flags", c.flags, kEncodeH264CapNames);
    ...
    EMIT_FLAGS("stdSyntaxFlags", c.stdSyntaxFlags, kEncodeH264StdNames);
}

void emitCodecCaps(const VkVideoEncodeH265CapabilitiesKHR& c)
{
    EMIT_FLAGS("flags", c.flags, kEncodeH265CapNames);
    g_emit->u64("maxLevelIdc", c.maxLevelIdc);
    ...
    g_emit->boolean("prefersGopRemainingFrames", c.prefersGopRemainingFrames);
    g_emit->boolean("requiresGopRemainingFrames", c.requiresGopRemainingFrames);
    EMIT_FLAGS("stdSyntaxFlags", c.stdSyntaxFlags, kEncodeH265StdNames);
}

void emitCodecCaps(const VkVideoEncodeAV1CapabilitiesKHR& c)
{
    EMIT_FLAGS("flags", c.flags, kEncodeAV1CapNames);
    ...
    g_emit->boolean("prefersGopRemainingFrames", c.prefersGopRemainingFrames);
    g_emit->boolean("requiresGopRemainingFrames", c.requiresGopRemainingFrames);
    EMIT_FLAGS("stdSyntaxFlags", c.stdSyntaxFlags, kEncodeAV1StdNames);
}
